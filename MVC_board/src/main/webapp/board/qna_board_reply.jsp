		...
		<form action="BoardReplyPro.bo" name="boardForm" method="post" enctype="multipart/form-data">
			...
			<table>
				...
				<tr>
					...
					<td class="td_right">
						<textarea id="board_content" name="board_content" required="required" cols="40" rows="15" required="required">${board.board_content }</textarea>
					</td>
				</tr>
				<tr>
					<td class="td_left"><label for="board_file">파일</label></td>
					<td class="td_right">
					<!-- 답글 작성 시 파일 업로드는 선택 사항으로 required 옵션은 제거 -->
