...
<%
	...
	//=> 파라미터: 글 번호(idx)  리턴타입 : BoardDTO (file_board)
				...
				<table id="notice">
					<tr>
						...
						<td><input type="text" name="name"
								value= "<%=fileboard.getName() %>" required="required" readonly="readonly"></td>
					</tr>
					<tr>
						<td>패스워드</td>
					...
					<tr>
						<td>파일</td>
						<td><input type="file" name="original_file" ><br>
