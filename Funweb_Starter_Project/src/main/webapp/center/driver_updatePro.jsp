...
// FileBoardDAO 객체의 isCorrectPass() 메서드를 호출하여 패스워드 일치 여부 판별
// => 파라미터 : FileBoardDTO 객체    리턴타입 : boolean(isCorrectPass)
FileBoardDAO dao = new FileBoardDAO();
// boolean isCorrectPass = dao.isCorrectPass(fileBoard);

// 패스워드 일치 여부에 따른 작업    
// if(isCorrectPass) { // 패스워드 일치 시
